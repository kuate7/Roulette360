...
def colorbet(rouletteSpinNumber):
    if rouletteSpinNumber in [1, 3, 5, 7, 9, 12, 14, 16, 18, 19, 21, 23,25, 27, 30, 32, 34 ,36]:
        return "red"
    elif rouletteSpinNumber in [2, 4, 6, 8, 10, 11, 13, 15, 17, 20, 22, 24, 26, 28, 29, 31, 33, 35]:
        return "black"
...
while continuePlay == "Y" or continuePlay == "y" and userBalance > 0:
    ...
    rouletteSpinNumberMetadata = [rouletteSpinNumber, oddOrEven(rouletteSpinNumber), bottomOrTopHalf(rouletteSpinNumber), DozenSet(rouletteSpinNumber), colorbet(rouletteSpinNumber)]
